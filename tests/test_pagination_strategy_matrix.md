...
|---------|---------------------|--------------------------------------|-----------------|-------|
| TC-N-01 | Fixed strategy, page < max_pages | Equivalence – normal | should_fetch_next = True | - |
...
| TC-N-05 | Exhaustive strategy, page < max_pages | Equivalence – normal | should_fetch_next = True | - |
...
| TC-B-01 | current_page = max_pages | Boundary – max | should_fetch_next = False | - |
| TC-B-02 | current_page = max_pages + 1 | Boundary – max+1 | should_fetch_next = False | - |
...
| TC-E-02 | serp_max_pages in cache key | Effect – different cache | Different cache keys for different max_pages | - |
