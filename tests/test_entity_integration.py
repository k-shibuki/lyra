...
from src.crawler.rdap_whois import WHOISRecord, RegistrantInfo, NameserverInfo
from src.crawler.crt_transparency import CertSearchResult, CertificateInfo
...
def sample_whois_record():
    ...
    return WHOISRecord(
        ...
        created_date=datetime(2020, 1, 15, tzinfo=timezone.utc),
        updated_date=datetime(2024, 1, 15, tzinfo=timezone.utc),
        expiry_date=datetime(2025, 1, 15, tzinfo=timezone.utc),
        nameservers=[
...
def sample_cert_result():
    ...
    return CertSearchResult(
        ...
        earliest_cert=datetime(2020, 1, 1, tzinfo=timezone.utc),
        latest_cert=datetime(2024, 6, 1, tzinfo=timezone.utc),
