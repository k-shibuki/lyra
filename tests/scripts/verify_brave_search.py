#!/usr/bin/env python3
"""
Brave Search Engine E2E Verification

Verification target: ADR-0003 Agent Execution (Browser Search) - Brave

Brave characteristics:
- Independent search engine with own index
- Privacy-focused (no tracking)
- Last-mile engine (daily_limit: 50 in engines.yaml)
- May have stricter bot detection

Verification items:
1. CDP connection
2. Brave search operation
3. Search result parser accuracy (BraveParser)
4. CAPTCHA detection
...
Note:
    This script accesses real Brave search.
    Brave has stricter limits - use sparingly.

Related scripts:
    - verify_duckduckgo_search.py
    - verify_ecosia_search.py
    - verify_mojeek_search.py
"""
...
class BraveSearchVerifier:
    """Verifier for Brave search functionality."""

    ENGINE_NAME = "brave"
    ENGINE_DISPLAY = "Brave"
    ...
    async def check_prerequisites(self) -> bool:
        ...
        print("    Brave has daily limits (50) - use sparingly.\n")
        return True
    ...
    async def verify_search(self) -> VerificationResult:
        ...
        try:
            test_query = "privacy focused web browser"
    ...
    async def verify_parser_accuracy(self) -> VerificationResult:
        ...
        try:
            test_query = "Wikipedia online encyclopedia"
