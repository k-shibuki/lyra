...
@pytest.fixture
def sample_paper_with_doi() -> Paper:
...
@pytest.fixture
def sample_paper_without_doi() -> Paper:
    """Paper without DOI."""
    return Paper(
        id="test:456",
        title="Test Paper 2",
...
@pytest.fixture
def sample_paper_with_oa_url() -> Paper:
    """Paper with existing OA URL."""
    return Paper(
        id="test:789",
        title="Test Paper 3",
        abstract="Test abstract 3",
        authors=[Author(name="Bob Smith", affiliation=None, orcid=None)],
        year=2024,
        published_date=None,
        doi="10.1234/test3",
        arxiv_id=None,
...
class TestAcademicSearchProviderIntegration:
    ...
    @pytest.mark.asyncio
    async def test_resolve_oa_url_for_paper_success(self, sample_paper_with_doi: Paper) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_oa_url_for_paper_api_failure(self, sample_paper_with_doi: Paper) -> None:
