...
class TestUCBAllocator:
    ...
    def test_ucb_score_with_priority_boost(self):
    ...
    def test_reallocate_budget_unplayed_arms(self):
    ...
    def test_reallocate_budget_based_on_harvest_rate(self):
    ...
    def test_reallocate_budget_respects_max_ratio(self):
...
class TestUCBAllocatorIntegration:
    ...
    @pytest.mark.asyncio
    async def test_exploration_state_with_ucb(self):
    ...
    @pytest.mark.asyncio
    async def test_exploration_state_without_ucb(self):
    ...
    @pytest.mark.asyncio
    async def test_record_fragment_updates_ucb(self):
    ...
    @pytest.mark.asyncio
    async def test_get_dynamic_budget(self):
    ...
    @pytest.mark.asyncio
    async def test_get_dynamic_budget_without_ucb(self):
    ...
    @pytest.mark.asyncio
    async def test_get_ucb_scores(self):
        """Test getting UCB scores for all subqueries."""
        from src.research.state import ExplorationState
