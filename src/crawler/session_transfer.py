...
class CookieData(BaseModel):
    ...
    expires: float | None = Field(default=None, description="Expiration as Unix timestamp")
...
class TransferResult(BaseModel):
    ...
    reason: str | None = Field(default=None, description="Failure reason if ok=False")
...
_session_transfer_manager: SessionTransferManager | None = None
