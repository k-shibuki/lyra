...
- [ ] **アグリゲータ/AI生成検出**
  - テンプレ/広告密度/本文構造/表現反復からの特徴量化
  - 検出時の減点適用
- [ ] **SEOスパム検出**
  - ドメイン/テンプレ異常検出

#### 16.2.5 時系列整合チェック (§3.3.3)
- [ ] **主張時点 vs ページ更新日の不整合検出**
  - 古い主張の信頼度減衰
  - タイムスタンプ整合性検証
...
| Phase 15: ドキュメント | ✅ | 100% | |
| **Phase 16: 未実装機能** | 🔄 | 20% | **33項目残り（sec-fetch-*, sec-ch-ua*, webdriver override, viewport jitter, browser archive完了）** |
