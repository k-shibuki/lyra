...
- [ ] **仕様書確認**: `requirements.md`の該当セクションを確認し、要件を理解した
...
- [ ] **仕様準拠性**: 実装が`requirements.md`の要件を満たしていることを確認した
...
- **実装前に必ず`requirements.md`を確認**: 該当セクションを読み、要件を正確に理解する
