...
#### Lancetの位置づけ: コンテキストエンジニアリングの一部

Lancetは**すべてを自動化することが目的ではない**。Cursor AIや人間と協調し、調査プロセス全体の一部を担う。

| 役割 | Lancet（自動化） | 人間 / Cursor AI |
|------|:---------------:|:----------------:|
| **情報発見** | ✅ 検索・論文発見 | - |
| **メタデータ収集** | ✅ 抄録・引用・信頼性指標 | - |
...
この分業により、Lancetは**OSINT品質に直結する発見・収集・構造化**に専念し、**解釈・判断は人間/Cursor AI**が担う。
